...
namespace DynamicInterop
{
   ...
   {
      private readonly SafeHandleUnmanagedDll handle;
...
//                strMsg = strMsg + string.Format(". {0}", ldLibPathMsg);
      ...
      private readonly ConcurrentDictionary<string, object> delegateFunctionPointers = new ConcurrentDictionary<string, object>();

      /// <summary>
      ///    Creates the delegate function for the specified function defined in the DLL.
      /// </summary>
      /// <typeparam name="TDelegate">
      ///    The type of delegate. The name of the native function is assumed to be the same as the
      ///    delegate type name.
      /// </typeparam>
      ...
      /// </summary>
      /// <remarks>
      ///    Call <see cref="Dispose()" /> when you are finished using the <see cref="DynamicInterop.UnmanagedDll" />. The
      ...
      ///    <see cref="DynamicInterop.UnmanagedDll" /> was occupying.
      /// </remarks>
      public void Dispose()
      {
         Dispose(true);
      ...
      /// <remarks>
      ///    Throws an <exception cref="System.ArgumentException">ArgumentException</exception> if the symbol is not
